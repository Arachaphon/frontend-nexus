...
// ประกาศ Type เพื่อให้ TypeScript ไม่ฟ้อง Error เวลาเรียก window.__ENV__
declare global {
  interface Window {
    __ENV__: {
      API_BASE: string;
...
const RegisterPage: React.FC = () => {
  ...
  // Component ไอคอน SVG (เพื่อไม่ต้องลง Library เพิ่ม)
  const EyeIcon = () => (
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input 
              ...
              className={`${inputStyle} ${errors.username ? 'ring-2 ring-red-500' : ''}`} 
            />
          ...
          <div>
            ...
            <div className="relative">
                ...
                className={`${inputStyle} pr-10 ${errors.password ? 'ring-2 ring-red-500' : ''}`} 
                />
                <button
                    type="button"
          ...
          <div>
            ...
            <div className="relative">
                ...
                onChange={handleChange} 
                // เพิ่ม pr-10 เพื่อเว้นที่ให้ไอคอน
                className={`${inputStyle} pr-10 ${errors.confirmPassword ? 'ring-2 ring-red-500' : ''}`} 
                />
                <button
                    type="button"
